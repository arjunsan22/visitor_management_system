...
export const HeroSection = () => {
    return (
        <section className="relative flex flex-1 items-center justify-center overflow-hidden bg-[#070A1B] px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="relative z-10 w-full max-w-xl rounded-[2.1rem] bg-[#0F1535]/80 backdrop-blur-2xl border border-white/[0.08] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] sm:p-12 transition-all">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-3 text-sm text-gray-400 sm:text-base leading-relaxed max-w-md mx-auto">
                ...
                <div className="mt-10 flex flex-col gap-4">
                    ...
                    {/* Primary Action Button: New Visitor (Gleaming Modern Style) */}
                    <Link
                        to="/visitor/new"
                    ...
                    {/* Secondary Action Button: Show Pass (Clean Minimalist Enterprise Style) */}
                    <button
...
<span className="hidden sm:block text-xs text-gray-400 font-normal">Retrieve active digital entry pass</span>                            </div>
                        </div>
                ...
                {/* Modern Help & Quick Support Footer Style */}
